...
class Vision:
    ...
    def init_control_gui(self):
        cv.namedWindow(self.TRACKBAR_WINDOW, cv.WINDOW_AUTOSIZE)
        cv.resizeWindow(self.TRACKBAR_WINDOW, 500, 800)
        ...
        #cv.createButton("Edge detection",self.callbackButton,None,cv.QT_CHECKBOX,0);
        ...
        cv.setTrackbarPos('KernelSize', self.TRACKBAR_WINDOW, 1)
        cv.setTrackbarPos('Canny1', self.TRACKBAR_WINDOW, 100)
        cv.setTrackbarPos('Canny2', self.TRACKBAR_WINDOW, 200)

    def callbackButton(*args):
        self.DO_EDGE_DETECTION=True;
        return    
